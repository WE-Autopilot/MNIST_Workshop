# MAKE SURE TO RUN gui.py MANUALLY AFTER RUNNING train.py
...
from util import header, plot_distribution, double_plot, normalization_transform # Functions Aly defined in the lib folder (util.py)
